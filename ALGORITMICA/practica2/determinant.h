// This code is adapted from CGAL.
...
double dynamic_programming_determinant(const Matrix&m)
{
  switch(m.dimension_1()) {
  case 2: return det2x2_by_formula(m(0,0), m(1,0),
			           m(0,1), m(1,1));
  case 3: return det3x3_by_formula(m(0,0), m(1,0), m(2,0),
			           m(0,1), m(1,1), m(2,1),
			           m(0,2), m(1,2), m(2,2));
  case 4: return det4x4_by_formula(m(0,0), m(1,0), m(2,0), m(3,0),
			           m(0,1), m(1,1), m(2,1), m(3,1),
			           m(0,2), m(1,2), m(2,2), m(3,2),
			           m(0,3), m(1,3), m(2,3), m(3,3));
  case 5: return det5x5_by_formula(m(0,0), m(1,0), m(2,0), m(3,0), m(4,0),
			           m(0,1), m(1,1), m(2,1), m(3,1), m(4,1),
			           m(0,2), m(1,2), m(2,2), m(3,2), m(4,2),
			           m(0,3), m(1,3), m(2,3), m(3,3), m(4,3),
			           m(0,4), m(1,4), m(2,4), m(3,4), m(4,4));
  default:
	  std::cerr << "Dimension out of bounds" << std::endl;
	  exit(1);
  }
}
